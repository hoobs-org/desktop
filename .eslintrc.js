module.exports = {
    ...
    overrides: [
        ...
        {
            files: ["src/components/monaco.js"],
            rules: {
        ...
        },
        {
            ...
            rules: { "@typescript-eslint/explicit-module-boundary-types": ["error"], "no-param-reassign": "off" },
        },
        {
            files: ["src/shims-tsx.d.ts"],
            rules: { "@typescript-eslint/explicit-module-boundary-types": ["error"], "no-underscore-dangle": "off" },
        },
        {
            files: ["vue.config.js"],
        ...
        {
            files: ["src/plugins/electron.ts"],
            rules: { "@typescript-eslint/no-var-requires": "off", "global-require": "off" },
        },
        {
            files: ["src/plugins/emoji.ts"],
            rules: { "@typescript-eslint/no-var-requires": "off", "global-require": "off" },
        },
        {
            files: ["src/services/scanner.ts"],
            rules: { "no-await-in-loop": "off", "class-methods-use-this": "off" },
        },
        {
        ...
        {
            files: ["src/services/validators.ts"],
        ...
        {
            files: ["bin/*"],
            rules: { "import/no-extraneous-dependencies": "off", "@typescript-eslint/no-var-requires": "off" },
        },
    ],
};
