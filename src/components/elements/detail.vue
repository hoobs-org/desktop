    ...
    <div v-if="!plugin.deleted" id="detail">
        ...
        <div class="item">
            <div class="value">
                ...
                <a href="#" :onclick="`window.$open('https://plugins.hoobs.org/${plugin.name}');`">
                    <icon name="link" class="icon" />
                    hoobs.org
                </a>
            </div>
...
<script>
    ...
    import TrendChartComponent from "vue-trend-chart";

    export default {
        name: "detail",
        props: { plugin: Object, installed: Array },
        components: { "trend-chart": TrendChartComponent },
